    ...
    <div id="app_register">
        ...
        <form id="registerForm" @submit.prevent="addUser">
            <div class="form-group">
                ...
                <input v-model="newUser.first_name" class="form-control" id="first_name" type="text" placeholder="enter first name...">
                <p v-if="errors.first_name" style="color:red">{{errors.first_name[0]}}</p>
            </div>

            <div class="form-group">
                <label>Last name</label> <br>
                <input v-model="newUser.last_name" class="form-control" id="last_name" type="text" placeholder="enter last name...">
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="true" value="true" v-model="newUser.terms_accepted">
